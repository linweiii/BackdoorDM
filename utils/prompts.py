...
def get_bdPrompts_fromVillanDataset_random(args, dataset_text, num):
    trigger = CaptionBackdoor().get_trigger(args.trigger) # latte_coffee
    bd_prompts_list = add_trigger_villan_cond(dataset_text, trigger)
    return bd_prompts_list[:num]
