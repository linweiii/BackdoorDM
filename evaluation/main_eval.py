...
if __name__ == '__main__':
    ...
    parser.add_argument('--backdoor_method', '-bd', type=str, default='villandiffusion')
    parser.add_argument('--backdoored_model_path', type=str, default='./results/villandiffusion_DDPM-CELEBA-HQ-256')
    ...
    parser.add_argument('--img_num_FID', type=int, default=5000)
    parser.add_argument('--image_column', type=str, default=None)
    parser.add_argument('--caption_column', type=str, default='text')
    
    parser.add_argument('--eval_max_batch', '-eb', type=int, default=32)
    ...
    if cmd_args.backdoor_method in ['baddiffusion', 'trojdiff', 'villandiffusion', 'villandiffusion_cond', 'invi_backdoor']:
        if cmd_args.backdoor_method == 'villandiffusion_cond':
            ...
            if 'defense' in args.backdoored_model_path:
                args.use_lora = False
                args.backdoored_model_path = os.path.join(args.backdoored_model_path, 'defended_model')
        else:
